...
{ 
public:     
    virtual IvVertexBuffer* CreateVertexBuffer( IvVertexFormat format, unsigned int numVertices ) = 0; 
    virtual void Destroy( IvVertexBuffer* vb) = 0; 
    
    virtual IvIndexBuffer* CreateIndexBuffer( unsigned int numIndices ) = 0;
